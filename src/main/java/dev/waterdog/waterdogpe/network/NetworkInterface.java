...
public interface NetworkInterface {
     ...
     *
     * @throws NetworkStartupException if the network interface fails to start.
     */
    void start(InetSocketAddress address) throws NetworkStartupException;

    /**
     * Shuts down the network interface, closing connections and releasing resources.
     */
    void shutdown();

    /**
     * Called every tick to allow the network interface to perform updates.
     */
    default void tick() {
    }
